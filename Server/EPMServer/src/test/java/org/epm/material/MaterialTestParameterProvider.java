...
public class MaterialTestParameterProvider
    ...
    protected MaterialDTO provideSingleAttribute(MaterialDTO dto, final int caseNumber) {
        ...
        switch (caseNumber % getDTOAttrCount()) {
            case 0:
                dto.setName("Material " + random.nextInt(2000));
            case 1:
                dto.setNorm((random.nextBoolean() ? "DIN" : "ISO") + (random.nextInt(1500) + 500));
            case 2:
                dto.setDimensions(random.nextInt(200) + "x" + random.nextInt(160) + "x" + random.nextInt(40));
            case 3:
                dto.setWeight(random.nextInt(30000) / 100f);
            case 4:
                dto.setTotalQty(random.nextInt(60));
            case 5:
                dto.setFreeQty(random.nextInt(20));
            case 6:
                dto.setUnit(Unit.randomUnit());
        }
        return dto;
    }
